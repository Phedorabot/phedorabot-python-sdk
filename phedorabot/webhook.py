...
class PhedorabotWebHookEngine(object):
    ...
    def add_result(self, rkey, rvalue):
        self.results[str(rkey)] = rvalue
    ...
    def is_valid_task_execution(self):
        ...
        try:
            self.will_validate_task_execution()
    ...
    def verify_task_execution_payload(self):
        ...
        self.add_result('computed_hmac', hmac_str)
    ...
    def will_validate_task_execution(self):
    ...
    def send_response(self):
        # This prints the response in json format
        print (json.dumps(self.build_response()))
